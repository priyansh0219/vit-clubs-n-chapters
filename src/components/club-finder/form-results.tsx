    ...
    <div className='fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4'>
      ...
      >
        <Card className='bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg border-0 shadow-2xl'>
          ...
          {/* Results */}
          <CardContent className='overflow-y-auto max-h-[60vh] space-y-6 custom-scrollbar'>
          ...
          <div className='p-6 pt-4 bg-gray-50/50 dark:bg-gray-800/50 border-t'>
            <div className='flex items-center justify-between'>
              <div className='text-sm text-gray-600 dark:text-gray-400'>
                💡 These recommendations are based on your preferences. Explore
                more to find hidden gems!
              </div>
              <div className='flex items-center gap-2'>
                <Button
                  variant='outline'
